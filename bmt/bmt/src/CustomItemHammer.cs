...
namespace bmt.src
{
    public class CustomItemHammer: ItemHammer
    {
        ...
        private Dictionary<int, MultiTextureMeshRef> meshrefs
        {
            get
            {
                return ObjectCacheUtil.GetOrCreate<Dictionary<int, MultiTextureMeshRef>>(this.api, "bmthammersmeshrefs", () => new Dictionary<int, MultiTextureMeshRef>());
            }
        }
        ...
        public override void OnCreatedByCrafting(ItemSlot[] allInputslots, ItemSlot outputSlot, GridRecipe byRecipe)
        {
            ...
            jsonItemStack.Code = new AssetLocation("bmt:hammer-" + material);
            ...
            var c = jsonItemStack.Resolve(this.api.World, "bmt hammer", true);
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            {
                dsc.Append(Lang.Get("A {0} {1} Hammer with a {2} handle and {3} bindings", Lang.Get("bmt:bonus-" + bonus),
            ...
            {
                dsc.Append(Lang.Get("A {0} Hammer with a {1} handle and {2} bindings", Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle),
                                                                                            Lang.Get("bmt:binding-" + stri)));
                return;
            }
            ...
            {
                dsc.Append(Lang.Get("A {0} {1} Hammer with a {2} handle", Lang.Get("bmt:bonus-" + bonus),
                                                                                            Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle)));
                return;
            }
            ...
            {
                dsc.Append(Lang.Get("A {0} Hammer with a {1} handle", Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle)));
                return;
            }
        }
        private JsonItemStack genJstack(string json)
        {
            ...
            jsonItemStack.Resolve(this.api.World, "bmt hammer", true);
        ...
        public MeshData GenMesh(ItemStack itemstack, ITextureAtlasAPI targetAtlas, BlockPos atBlockPos)
        {
            ...
            {
                shapeName = "rtools/hammer";
            }
            else if (worktype.Equals("smelted"))
            {
                shapeName = "tools/hammer-copper";
            }
            else
            {
                shapeName = "tools/hammer-iron";
            }
            ...
            cnts.Textures["vine"] = new AssetLocation("bmt:binding/vines.png");
            ...
            MeshData meshBlade;
            (api as ICoreClientAPI).Tesselator.TesselateShape("item shape", shapeHammer, out meshBlade, cnts, null, 0, 0, 0, null, null);
            return meshBlade;
        }
