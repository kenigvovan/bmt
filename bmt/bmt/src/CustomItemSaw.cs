...
namespace bmt.src
{
    public class CustomItemSaw: Item, IContainedMeshSource
    {
        ...
        private Dictionary<int, MultiTextureMeshRef> meshrefs
        {
            get
            {
                return ObjectCacheUtil.GetOrCreate<Dictionary<int, MultiTextureMeshRef>>(this.api, "bmtsawmeshrefs", () => new Dictionary<int, MultiTextureMeshRef>());
            }
        }
        ...
        public override void OnCreatedByCrafting(ItemSlot[] allInputslots, ItemSlot outputSlot, GridRecipe byRecipe)
        {
            ...
            jsonItemStack.Code = new AssetLocation("bmt:saw-" + material);
            ...
            var c = jsonItemStack.Resolve(this.api.World, "sometools saw", true);
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            {
                dsc.Append(Lang.Get("A {0} {1} Saw with a {2} handle and {3} bindings", Lang.Get("bmt:bonus-" + bonus),
            ...
            {
                dsc.Append(Lang.Get("A {0} Saw with a {1} handle and {2} bindings", Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle),
                                                                                            Lang.Get("bmt:binding-" + stri)));
                return;
            }
            ...
            {
                dsc.Append(Lang.Get("A {0} {1} Saw with a {2} handle", Lang.Get("bmt:bonus-" + bonus),
                                                                                            Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle)));
                return;
            }
            ...
            {
                dsc.Append(Lang.Get("A {0} Saw with a {1} handle", Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle)));
                return;
            }
        }
        private JsonItemStack genJstack(string json)
        {
            ...
            jsonItemStack.Resolve(this.api.World, "sometools saw", true);
        ...
        public MeshData GenMesh(ItemStack itemstack, ITextureAtlasAPI targetAtlas, BlockPos atBlockPos)
        {
            ...
            {
                shapeName = "tools/saw-iron";
            }
            else if (worktype.Equals("smelted"))
            {
                shapeName = "tools/saw-copper";
            }
            else
            {
                shapeName = "tools/saw-iron";
            ...
            cnts.Textures["wood"] = new AssetLocation("game:item/tool/material/wood");
