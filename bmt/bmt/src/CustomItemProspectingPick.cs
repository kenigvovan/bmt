...
namespace bmt.src
{
    public class CustomItemProspectingPick: ItemProspectingPick
    {
        ...
        private Dictionary<int, MultiTextureMeshRef> meshrefs
        {
            get
            {
                return ObjectCacheUtil.GetOrCreate<Dictionary<int, MultiTextureMeshRef>>(this.api, "bmtpropickaxesmeshrefs", () => new Dictionary<int, MultiTextureMeshRef>());
            }
        }
        ...
        public override void OnCreatedByCrafting(ItemSlot[] allInputslots, ItemSlot outputSlot, GridRecipe byRecipe)
        {
            ...
            jsonItemStack.Code = new AssetLocation("bmt:prospectingpick-" + material);
            ...
            var c = jsonItemStack.Resolve(this.api.World, "sometools prospectingpick", true);
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            {
                dsc.Append(Lang.Get("A {0} {1} Prospecting Pickaxe with a {2} handle and {3} bindings", Lang.Get("bmt:bonus-" + bonus),
            ...
            {
                dsc.Append(Lang.Get("A {0} Prospecting Pickaxe with a {1} handle and {2} bindings", Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle),
                                                                                            Lang.Get("bmt:binding-" + stri)));
                return;
            }
            ...
            {
                dsc.Append(Lang.Get("A {0} {1} Prospecting Pickaxe with a {2} handle", Lang.Get("bmt:bonus-" + bonus),
                                                                                            Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle)));
                return;
            }
            ...
            {
                dsc.Append(Lang.Get("A {0} Prospecting Pickaxe with a {1} handle", Lang.Get("game:material-" + material),
                                                                                            Lang.Get("bmt:handle-" + handle)));
                return;
            }
        }
        private JsonItemStack genJstack(string json)
        {
            ...
            jsonItemStack.Resolve(this.api.World, "sometools prospectingpick", true);
        ...
        public MeshData GenMesh(ItemStack itemstack, ITextureAtlasAPI targetAtlas, BlockPos atBlockPos)
        {
            ...
            Shape shapePropick = (this.api as ICoreClientAPI).Assets.TryGet("bmt:shapes/item/tools/prospectingpick.json").ToObject<Shape>();
            ...
            (api as ICoreClientAPI).Tesselator.TesselateShape("item shape", shapePropick, out meshPickaxe, cnts, null, 0, 0, 0, null, null);
            return meshPickaxe;
        }
